            ...
            <div class="page" id="page">
                ...
                <div class="blocCentre" id="blocCentre">
                    <?php if (!isset($_GET['id']) && !isset($showAlaUne)) { ?>
                        ...
                        <?php for ($i = 0; $i < count($showRestaurant); $i++) { ?>



                            <a href="restaurant-<?php echo $showRestaurant[$i][2]; ?>-<?php echo $showRestaurant[$i][0]; ?>">
                                <p class="parag2"><?php echo $showRestaurant[$i][4]; ?></p>
                            </a>
                            <p id="texteAnnonces">

                                <?php
                                echo $showRestaurant[$i][4]; ?><br /><br />
                    ...
                    <div id="detailsH">
                        <?php if (isset($showDetails)) { 
                            ...
                            <div class="bottom">
                                ...
                                <a href="javascript:window.open('mailto:?subject=Un bon lien à visiter&body=Salut ! j\'ai trouvé cette annonce pour toi : index.php?page=restaurant Bonne journée.')"> <img src="src/public/picture/site/mail.png" alt="mail"></a>
                                ...
                                <?php if (isset($_SESSION['name'])&& !isset($_SESSION['admin'])) { ?>
                                    <a href="restaurant-fav-2-<?php echo $showDetails[0]; ?>"> <img src="src/public/picture/site/like.png" alt="like" class="like"></a>
                        ...
                        <?php if (isset($showAlaUne) && !empty($showAlaUne)) { 
                            ...
                            <img src="src/public/picture/site/facebook.png" alt="facebook">
                                ...
                                <!-- <img src="src/public/picture/imprimer.png" alt="imprimer"> -->
                                <?php if (isset($_SESSION['name'])&& !isset($_SESSION['admin'])) { ?>
                                    <a href="restaurant-fav-2-<?php echo $showAlaUne[0]; ?>"> <img src="src/public/picture/site/like.png" alt="like" class="like"></a>
                                <?php } else { ?> <img src="src/public/picture/site/like.png" alt="like" class="like"> <?php } ?>
                                <!-- <p>hjhkjh</p> -->
                            </div>
